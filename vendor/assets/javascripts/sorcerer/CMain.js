function CMain(oData){
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_bg","/assets/sorcerer/but_play_bg.png");
        s_oSpriteLibrary.addSprite("but_exit","/assets/sorcerer/but_exit.png");
        s_oSpriteLibrary.addSprite("bg_menu","/assets/sorcerer/bg_menu.jpg");
        s_oSpriteLibrary.addSprite("audio_icon","/assets/sorcerer/audio_icon.png");
        s_oSpriteLibrary.addSprite("hero","/assets/sorcerer/hero.png");
        s_oSpriteLibrary.addSprite("hit_area","/assets/sorcerer/hit_area.png");
        s_oSpriteLibrary.addSprite("explosion","/assets/sorcerer/explosion.png");
        s_oSpriteLibrary.addSprite("msg_box","/assets/sorcerer/msg_box.png");
        s_oSpriteLibrary.addSprite("extra_score","/assets/sorcerer/extra_score.png");
        s_oSpriteLibrary.addSprite("end_path","/assets/sorcerer/end_path.png");
        
        for(var i=0;i<BALL_COLORS;i++){
            s_oSpriteLibrary.addSprite("ball_"+i,"/assets/sorcerer/ball_"+i+".png");
        }
		
		for(var j=0;j<s_oLevelSettings.getNumLevels();j++){
			s_oSpriteLibrary.addSprite("bg_game_"+(j+1),"/assets/sorcerer/bg_game_"+(j+1)+".jpg");
		}
